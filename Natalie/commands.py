...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            ...
            [
                InlineKeyboardButton('⚡ UPDATES ⚡', url=f"https://telegram.me/R_Mvzz"),
            ],
            [
        ...
        await asyncio.sleep(2) # 😢 https://github.com/EvamariaTG/EvaMaria/blob/master/Natalie/p_ttishow.py#L17 😬 wait a bit, before checking.
